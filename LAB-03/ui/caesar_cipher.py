    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.critical(self, "Error", "Encrypt API Error")
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.critical(self, "Error", "Decrypt API Error")
